...
Ep.runGetters = function () {
  ...
  if (! utils.getESModule(this.exports)) {
    // If the module this Entry is managing overrides module.exports, that
  ...
  if (utils.isObject(this.exports)) {
    var exportsKeys = safeKeys(this.exports);
    var exportsKeyCount = exportsKeys.length;
    for (var i = 0; i < exportsKeyCount; ++i) {
      var key = exportsKeys[i];
      var desc = Object.getOwnPropertyDescriptor(this.exports, key);
      if (hasOwn.call(desc, "value")) {
        // If this.exports[key] is a simple property, simply copy its
        // value over to this.namespace[key].
        this.namespace[key] = desc.value;
      } else {
        // Avoid triggering getters until necessary.
        desc.configurable = true;
        Object.defineProperty(this.namespace, key, desc);
      }
    }
  }
